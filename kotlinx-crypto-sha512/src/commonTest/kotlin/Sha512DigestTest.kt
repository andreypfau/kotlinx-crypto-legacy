import io.github.andreypfau.kotlinx.crypto.sha512.sha512
...
class Sha512DigestTest {
    ...
    fun testGolden(output: String, input: String) {
        assertEquals(output, hex(sha512(input.encodeToByteArray())))
    }
}
